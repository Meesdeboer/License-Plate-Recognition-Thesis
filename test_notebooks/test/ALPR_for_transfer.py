...
def crop_license_plate(img):
    ...
    save_dir = "../../../images/transfer/yolo/"

    #open image
    img_to_save = Image.open(img)
    width, height = img_to_save.size

    with open(save_dir + "labels/" + random_name + ".txt", "w") as f:
        f.write(f"0 {point1[0]/width} {point1[1]/height} {point2[0]/width} {point2[1]/height} {point3[0]/width} {point3[1]/height} {point4[0]/width} {point4[1]/height}")

    # save image
    img_to_save.save(save_dir + "images/" + random_name + ".jpg")
...
def predict_characters(characters, idx):
    ...
    for i, char in enumerate(characters):
        ...
        # random name
        random_name = str(random.randint(0, 1000000))
        # img_ocr = Image.fromarray(img_array)
        ...
        # save image
        # new_img.save(f"../../../images/transfer/ocr/{preds[0]}_{random_name}.jpg")
        new_img.save(f'{random_name}_char.jpg')
